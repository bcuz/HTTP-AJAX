    ...
    return (
      <Router>
        <div>                  
          ...
          <Route path="/update/:id" render={props => <Form {...props} putFriend={this.putFriend} postFriend={this.postFriend} updateItems={this.updateItems} friends={this.state.friends} /> } />          
        </div>
      </Router>
    );
  }
